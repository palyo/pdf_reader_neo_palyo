...
public class CropImageView extends AppCompatImageView {
    ...
    private static final float MAGNIFIER_CROSS_LINE_WIDTH = 2f;
    private static final float MAGNIFIER_CROSS_LINE_LENGTH = 3;
    private static final float MAGNIFIER_BORDER_WIDTH = 2f;
    ...
    private final Xfermode mMaskXfermode = new PorterDuffXfermode(PorterDuff.Mode.DST_OUT);
    ...
    boolean mShowEdgeMidPoint = false;
    ...
    private void initAttrs(Context context, AttributeSet attrs) {
        ...
        mShowEdgeMidPoint = ta.getBoolean(R.styleable.CropImageView_civShowEdgeMidPoint, false);
    ...
    public void setAutoImgCrop() {
        if (getDrawable() == null) {
            Log.w(TAG, "should call after set drawable");
            return;
        }
        this.mCropPoints = mAutoPoints;
        invalidate();
    }
    ...
    public void setImageToCrop(Bitmap bmp) {
        setImageBitmap(bmp);
        mAutoPoints = SmartCropper.scan(bmp);
        setCropPoints(mAutoScanEnable ? mAutoPoints : null);
    }
