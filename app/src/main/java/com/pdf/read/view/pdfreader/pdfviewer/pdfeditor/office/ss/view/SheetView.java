...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.simpletext.model.IElementCollection;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.control.Spreadsheet;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.other.FindingMgr;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.other.FocusCell;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.other.SheetScroller;
...
public class SheetView {
    ...
    private final TableFormatView tableFormatView;
    private final CellRangeAddress selecetedCellsRange;
    ...
    public int getIndentWidth(int indent) {
        ...
        return (int) Math.round(2 * fontSize * indent * KeyKt.POINT_TO_PIXEL);
    }

    public int getIndentWidthWithZoom(int indent) {
        double fontSize = sheet.getWorkbook().getFont(0).getFontSize();
        return (int) Math.round(2 * fontSize * indent * KeyKt.POINT_TO_PIXEL * zoom);
    }
    ...
    private void initRowExtendedRangeAddress(Row row) {
        ...
        for (Cell cell : cells) {
            ...
            if (CellView.isComplexText(cell)) {
                ...
                AttrManage.instance().setPageWidth(attr, Math.round(Integer.MAX_VALUE * KeyKt.PIXEL_TO_TWIPS));
                ...
                AttrManage.instance().setPageWidth(attr, Math.round((lineWidth + indent + SSConstant.SHEET_SPACETOBORDER * 2) * KeyKt.PIXEL_TO_TWIPS));
