...
public final class Freeform extends AutoShape {
    ...
    Freeform(EscherContainerRecord escherRecord, Shape parent) {
    ...
    public GeneralPath getPath() {
        ...
        for (int i = 0, j = 0; i < numSegments && j < numPoints; i++) {
            ...
            if (Arrays.equals(elem, ShapeKit.SEGMENTINFO_MOVETO)) {
                ...
                path.moveTo(((float) x * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI),
                        ((float) y * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI));
                ...
                path.curveTo(((float) x1 * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI),
                        ((float) y1 * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI), ((float) x2 * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI),
                        ((float) y2 * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI), ((float) x3 * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI),
                        ((float) y3 * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI));
                ...
                if (Arrays.equals(pnext, ShapeKit.SEGMENTINFO_ESCAPE)) {
                    if (j + 1 < numPoints) {
                        ...
                        short x = LittleEndian.getShort(p, 0);
                        short y = LittleEndian.getShort(p, 2);
                        path.lineTo(((float) x * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI),
                                ((float) y * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI));
                    }
    ...
    public void setPath(GeneralPath path) {
        ...
        for (int i = 0; i < pntInfo.size(); i++) {
            ...
            LittleEndian.putShort(data, 0,
                    (short) ((pnt.getX() - bounds.getX()) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
            LittleEndian.putShort(data, 2,
                    (short) ((pnt.getY() - bounds.getY()) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
        ...
        opt.addEscherProperty(new EscherSimpleProperty(EscherProperties.GEOMETRY__RIGHT,
                (int) (bounds.getWidth() * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI)));
        opt.addEscherProperty(new EscherSimpleProperty(EscherProperties.GEOMETRY__BOTTOM,
                (int) (bounds.getHeight() * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI)));
