...
public class ShapeView {
    ...
    private void drawTextbox(Canvas canvas, Rect shapeRect, TextBox textbox) {
        ...
        if (root == null) {
            ...
            AttrManage.instance().setPageWidth(attr, (int) Math.round(textbox.getBounds().getWidth() * KeyKt.PIXEL_TO_TWIPS));

            AttrManage.instance().setPageHeight(attr, (int) Math.round(textbox.getBounds().getHeight() * KeyKt.PIXEL_TO_TWIPS));
