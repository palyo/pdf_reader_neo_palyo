package com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.xls.Reader.shared;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.style.BorderStyle;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.style.BuiltinFormats;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.style.CellBorder;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.style.CellStyle;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.style.NumberFormat;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.table.TableFormatManager;
...
public class StyleReader {
    private static final StyleReader reader = new StyleReader();
    ...
    private Font processFont(Element fontElement) {
        ...
        if (e != null) {
            font.setBold(
                    e.attributeValue("val") == null || Boolean.parseBoolean(e.attributeValue("val")));
        }
    ...
    private BackgroundAndFill processFill(Element fillElement) {
        ...
        if (patternFill != null) {
            ...
            if (ele != null) {
                fill.setBackgroundColor(book.getColor(getColorIndex(ele)));
            }
            return fill;
    ...
    private void processCellStyleAlignment(CellStyle cellStyle, Element alignment) {
        ...
        if (alignment.attributeValue("wrapText") != null) {
            if (alignment.attributeValue("wrapText").equals("false")) {
                cellStyle.setWrapText(false);
            } else if (alignment.attributeValue("wrapText").equals("true")) {
