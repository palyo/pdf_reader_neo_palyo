...
public class ShapeGroup extends Shape {
    ...
    public void setAnchor(Rectangle anchor) {
        ...
        EscherClientAnchorRecord clientAnchor = (EscherClientAnchorRecord) ShapeKit.getEscherChild(spContainer, EscherClientAnchorRecord.RECORD_ID);
        ...
        clientAnchor.setFlag((short) (anchor.y * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
        clientAnchor.setCol1((short) (anchor.x * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
        clientAnchor.setDx1((short) ((anchor.width + anchor.x) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
        clientAnchor.setRow1((short) ((anchor.height + anchor.y) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));

        EscherSpgrRecord spgr = (EscherSpgrRecord) ShapeKit.getEscherChild(spContainer, EscherSpgrRecord.RECORD_ID);

        spgr.setRectX1((int) (anchor.x * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
        spgr.setRectY1((int) (anchor.y * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
        spgr.setRectX2((int) ((anchor.x + anchor.width) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
        spgr.setRectY2((int) ((anchor.y + anchor.height) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
    }
    ...
    public Rectangle2D getCoordinates() {
        ...
        anchor.x = (float) spgr.getRectX1() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI;
        anchor.y = (float) spgr.getRectY1() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI;
        anchor.width = (float) (spgr.getRectX2() - spgr.getRectX1()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI;
        anchor.height = (float) (spgr.getRectY2() - spgr.getRectY1()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI;
    ...
    public void setCoordinates(Rectangle2D anchor) {
        ...
        int x1 = (int) Math.round(anchor.getX() * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI);
        int y1 = (int) Math.round(anchor.getY() * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI);
        int x2 = (int) Math.round((anchor.getX() + anchor.getWidth()) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI);
        int y2 = (int) Math.round((anchor.getY() + anchor.getHeight()) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI);
    ...
    public Rectangle2D getAnchor2D() {
        ...
        if (clientAnchor == null) {
            ...
            EscherChildAnchorRecord rec = (EscherChildAnchorRecord) ShapeKit.getEscherChild(spContainer, EscherChildAnchorRecord.RECORD_ID);
            anchor = new Rectangle2D.Float((float) rec.getDx1() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI, (float) rec.getDy1() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI, (float) (rec.getDx2() - rec.getDx1()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI, (float) (rec.getDy2() - rec.getDy1()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI);
        } else {
            anchor.x = (float) clientAnchor.getCol1() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI;
            anchor.y = (float) clientAnchor.getFlag() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI;
            anchor.width = (float) (clientAnchor.getDx1() - clientAnchor.getCol1()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI;
            anchor.height = (float) (clientAnchor.getRow1() - clientAnchor.getFlag()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI;
        }
