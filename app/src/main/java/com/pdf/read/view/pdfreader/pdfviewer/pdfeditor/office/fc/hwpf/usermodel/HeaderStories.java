...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.model.PlexOfCps;
...
public final class HeaderStories {
    ...
    private Range getSubrangeAt(int plcfHddIndex) {
        ...
        return new Range(headerStories.getStartOffset() + start, headerStories.getStartOffset()
                + end, headerStories);
    }
