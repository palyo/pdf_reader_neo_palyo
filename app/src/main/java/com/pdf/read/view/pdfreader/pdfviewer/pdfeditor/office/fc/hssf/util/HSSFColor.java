...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.Color;
...
public class HSSFColor implements Color {
    ...
    private static Hashtable<Integer, HSSFColor> createColorsByIndexMap() {
        ...
        for (int i = 0; i < colors.length; i++) {
            ...
            if (result.containsKey(index2)) {
                if (false) {
                    HSSFColor prevColor = result.get(index2);
    ...
    public final static class AUTOMATIC extends HSSFColor {
        ...
        private static final HSSFColor instance = new AUTOMATIC();
