...
class OptImageAdapter(val listener: (file: File, position: Int) -> Unit) : BaseAdapter<String, LayoutRowItemDocumentFileOptBinding>(bindingFactory = { inflater, parent, attachToRoot, viewType ->
