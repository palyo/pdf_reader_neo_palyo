...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.macro.UpdateStatusListener;
...
public class LeafView extends AbstractView {
    ...
    private static final StringBuffer title = new StringBuffer();
    ...
    public void initProperty(IElement elem, IElement paraElem) {
        ...
        if (charAttr.subSuperScriptType > 0) {
            paint.setTextSize(charAttr.fontSize * (charAttr.fontScale / 100.f) * KeyKt.POINT_TO_PIXEL / 2);
        } else {
    ...
    public boolean hasUpdatedFieldText() {
        return charAttr != null && charAttr.pageNumberType == WPModelConstant.PN_TOTAL_PAGES;
    }
