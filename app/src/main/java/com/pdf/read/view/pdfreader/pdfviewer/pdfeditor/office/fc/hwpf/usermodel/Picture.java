...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.model.PictureDescriptor;
...
public final class Picture extends PictureDescriptor {
    ...
    private final int dataBlockStartOfsset;
    private final int pictureBytesStartOffset;
    ...
    private void fillImageContent() {
        ...
        if (matchSignature(rawContent, COMPRESSED1, 32)
            ...
            try {
                ...
                this.tempFilePath = tempPath + File.separator + System.currentTimeMillis() + ".tmp";
