...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.openxml4j.opc.ContentTypes;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.openxml4j.opc.PackageProperties;
...
public final class PackagePropertiesPart extends PackagePart implements PackageProperties {
    ...
    private Nullable<String> description = new Nullable<String>();

    private Nullable<String> title = new Nullable<String>();

    private Nullable<String> category = new Nullable<String>();

    private Nullable<String> contentStatus = new Nullable<String>();

    private Nullable<String> contentType = new Nullable<String>();

    private Nullable<Date> created = new Nullable<Date>();

    private Nullable<String> creator = new Nullable<String>();

    private Nullable<String> identifier = new Nullable<String>();

    private Nullable<String> keywords = new Nullable<String>();

    private Nullable<String> language = new Nullable<String>();

    private Nullable<String> lastModifiedBy = new Nullable<String>();

    private Nullable<Date> lastPrinted = new Nullable<Date>();

    private Nullable<Date> modified = new Nullable<Date>();

    private Nullable<String> revision = new Nullable<String>();

    private Nullable<String> subject = new Nullable<String>();

    private Nullable<String> version = new Nullable<String>();
