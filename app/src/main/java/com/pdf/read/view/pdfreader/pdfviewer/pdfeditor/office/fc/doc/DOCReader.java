...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.borders.Border;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.borders.Borders;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.borders.Line;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.bulletnumber.ListData;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.bulletnumber.ListLevel;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.shape.WPAbstractShape;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.shape.WPAutoShape;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.shape.WPGroupShape;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.shape.WPPictureShape;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.model.PicturesTable;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.Bookmarks;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.BorderCode;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.CharacterRun;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.Field;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.HWPFAutoShape;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.HWPFShape;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.HWPFShapeGroup;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.HeaderStories;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.InlineWordArt;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.LineSpacingDescriptor;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.OfficeDrawing;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.OfficeDrawings;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.POIBookmark;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.Paragraph;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.PictureType;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.Range;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.Section;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.Table;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.TableCell;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.TableRow;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.util.LittleEndian;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.Rectangle;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.util.Arrays;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.wp.model.HFElement;
...
public class DOCReader extends AbstractReader {
    private final Pattern hyperlinkPattern = Pattern.compile("[ \\t\\r\\n]*HYPERLINK \"(.*)\"[ \\t\\r\\n]*");
    ...
    private void processDoc() throws Exception {
        poiDoc = new HWPFDocument(new FileInputStream(new File(filePath)));
    ...
    private void processSectionBorder(SectionElement secElem, Section section) {
        ...
        if (top != null || bottom != null
            ...
            if (top != null) {
                ...
                border.setSpace((short) (top.getSpace() * KeyKt.POINT_TO_PIXEL));
            ...
            if (bottom != null) {
                ...
                border.setSpace((short) (bottom.getSpace() * KeyKt.POINT_TO_PIXEL));
            ...
            if (left != null) {
                ...
                border.setSpace((short) (left.getSpace() * KeyKt.POINT_TO_PIXEL));
            ...
            if (right != null) {
                ...
                border.setSpace((short) (right.getSpace() * KeyKt.POINT_TO_PIXEL));
        ...
        for (int i = 0; i < runCount && !abortReader; i++) {
            ...
            if ((ch == '\t' && text.length() == 1)
                ...
                if (ch != 0x15 || lastch != 0x13) {
                    ...
                    field = poiDoc.getFields().getFieldByStartOffset(fieldsPart, run.getStartOffset());
                    isFieldCode = true;
                }
                continue;
    ...
    private boolean isPageNumber(Field field, String fieldCode) {
        if (field != null && (field.getType() == Field.PAGE || field.getType() == Field.NUMPAGES)) {
            return true;
        } else return fieldCode != null && (fieldCode.contains("NUMPAGES") || fieldCode.contains("PAGE"));
    }
    ...
    private BackgroundAndFill converFill(HWPFAutoShape shape, OfficeDrawing drawing, int shapeType) {
        ...
        if (shape != null) {
            ...
            if (type == BackgroundAndFill.FILL_SOLID || type == BackgroundAndFill.FILL_BACKGROUND) {
                ...
                com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.Color fillColor = shape.getForegroundColor();
                com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.Color fillbackColor = shape.getFillbackColor();
        ...
        if (poiShape instanceof HWPFAutoShape) {
            ...
            if (line != null || fill != null || shapeType == ShapeTypes.TextBox || shapeType == ShapeTypes.PictureFrame) {
                ...
                if (shapeType == ShapeTypes.PictureFrame) {
                    ...
                    if (startArrowType > 0) {
                        ArrowPathAndTail arrowPathAndTail = shape.getStartArrowPath(rect);
                    ...
                    if (endArrowType > 0) {
                        ArrowPathAndTail arrowPathAndTail = shape.getEndArrowPath(rect);
                        if (arrowPathAndTail != null && arrowPathAndTail.getArrowPath() != null) {
    ...
    private void processSimpleTextBox(EscherContainerRecord escherContainer, WPAutoShape autoShape, Section section) {
        ...
        AttrManage.instance().setPageWidth(attr, (int) (autoShape.getBounds().width * KeyKt.PIXEL_TO_TWIPS));

        AttrManage.instance().setPageHeight(attr, (int) (autoShape.getBounds().height * KeyKt.PIXEL_TO_TWIPS));

        if (section.getGridType() != PageAttr.GRIDTYPE_NONE) {
            AttrManage.instance().setPageLinePitch(attr, section.getLinePitch());
        }

        AttrManage.instance().setPageMarginTop(attr, (int) (ShapeKit.getTextboxMarginTop(escherContainer) * KeyKt.PIXEL_TO_TWIPS));

        AttrManage.instance().setPageMarginBottom(attr, (int) (ShapeKit.getTextboxMarginBottom(escherContainer) * KeyKt.PIXEL_TO_TWIPS));

        AttrManage.instance().setPageMarginLeft(attr, (int) (ShapeKit.getTextboxMarginLeft(escherContainer) * KeyKt.PIXEL_TO_TWIPS));

        AttrManage.instance().setPageMarginRight(attr, (int) (ShapeKit.getTextboxMarginRight(escherContainer) * KeyKt.PIXEL_TO_TWIPS));
    ...
    private void processWordArtTextbox(EscherContainerRecord escherContainer, WPAutoShape autoShape) {
        ...
        if (text != null && text.length() > 0) {
            ...
            AttrManage.instance().setFontSize(leafAttr, (int) ((fontsize - 1) * KeyKt.PIXEL_TO_POINT));

            com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.Color color = ShapeKit.getForegroundColor(escherContainer, null, KeyKt.APPLICATION_TYPE_PPT);
            if (color != null) {
    ...
    private boolean processShape(CharacterRun run, IElement leaf, boolean isWrap, int runIndex) {
        if (isWrap) {
            ...
            rect.x = (int) (drawing.getRectangleLeft() * KeyKt.TWIPS_TO_PIXEL);
            rect.y = (int) (drawing.getRectangleTop() * KeyKt.TWIPS_TO_PIXEL);
            rect.width = (int) ((drawing.getRectangleRight() - drawing.getRectangleLeft()) * KeyKt.TWIPS_TO_PIXEL);
            rect.height = (int) ((drawing.getRectangleBottom() - drawing.getRectangleTop()) * KeyKt.TWIPS_TO_PIXEL);
            ...
            com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.Picture pic = pictureTable.extractPicture(control.getSysKit().getPictureManage().getPicTempPath(),
                    run, false);
            ...
            if (pic != null && isSupportPicture(pic.suggestPictureType())) {
                ...
                Rectangle rect = new Rectangle();
                rect.width = (int) (pic.getDxaGoal() * KeyKt.TWIPS_TO_PIXEL * pic.getHorizontalScalingFactor() / 1000f);
                rect.height = (int) (pic.getDyaGoal() * KeyKt.TWIPS_TO_PIXEL * pic.getVerticalScalingFactor() / 1000f);
                picShape.setBounds(rect);
                ...
                if (inlineShape != null && inlineShape.getInlineWordArt() != null) {
                    ...
                    Rectangle rect = new Rectangle();
                    rect.width = (int) (inlineShape.getDxaGoal() * KeyKt.TWIPS_TO_PIXEL * inlineShape.getHorizontalScalingFactor() / 1000f);
                    rect.height = (int) (inlineShape.getDyaGoal() * KeyKt.TWIPS_TO_PIXEL * inlineShape.getVerticalScalingFactor() / 1000f);
    ...
    public boolean searchContent(File file, String key) throws Exception {
        ...
        HWPFDocument poiDoc = new HWPFDocument(Files.newInputStream(file.toPath()));
        Range range = poiDoc.getRange();
