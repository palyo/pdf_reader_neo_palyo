...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.bulletnumber.ListKit;
...
public class BNView extends AbstractView {
    ...
    public synchronized int doLayout(IDocument doc, DocAttr docAttr, PageAttr pageAttr, ParaAttr paraAttr,
        ...
        paint.setTextSize(charAttr.fontSize * (charAttr.fontScale / 100.f) * KeyKt.POINT_TO_PIXEL);
        ...
        int ex = (int) ((tW + getX()) % KeyKt.DEFAULT_TAB_WIDTH_PIXEL);
        if (ex > 0) {
            tW += (KeyKt.DEFAULT_TAB_WIDTH_PIXEL - ex);
        }
