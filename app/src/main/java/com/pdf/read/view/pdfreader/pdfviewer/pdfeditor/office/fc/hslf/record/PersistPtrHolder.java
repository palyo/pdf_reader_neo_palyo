...
public final class PersistPtrHolder extends PositionDependentRecordAtom {
    ...
    private final Hashtable<Integer, Integer> _slideLocations;
    private final Hashtable<Integer, Integer> _slideOffsetDataLocation;
    private byte[] _header;
    private byte[] _ptrData;

    private PersistPtrHolder(byte[] source, int start, int len) {
    ...
    public void updateOtherRecordReferences(Hashtable<Integer, Integer> oldToNewReferencesLookup) {
        ...
        for (int i = 0; i < slideIDs.length; i++) {
            ...
            Integer oldPos = _slideLocations.get(id);
            ...
            Integer dataOffset = _slideOffsetDataLocation.get(id);
