package com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.pictureefftect;
...
public class PictureEffectInfoFactory {
    ...
    public static PictureEffectInfo getPictureEffectInfor(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.usermodel.Picture pic) {
        if (pic == null) {
            return null;
        }
