...
public abstract class HSSFShape {
    ...
    public void processSimpleBackground(EscherContainerRecord escherContainer, AWorkbook workbook) {
        ...
        if (type == BackgroundAndFill.FILL_PICTURE) {
            ...
            Color color = ShapeKit.getFillbackColor(escherContainer, workbook, KeyKt.APPLICATION_TYPE_SS);
            if (color != null) {
            ...
            Color color = ShapeKit.getForegroundColor(escherContainer, workbook, KeyKt.APPLICATION_TYPE_SS);
            if (color != null) {
                setFillType(BackgroundAndFill.FILL_SOLID);
                setFillColor(color.getRGB(), 255);
                return;
    ...
    public BackgroundAndFill getGradientTileBackground(AWorkbook workbook, IControl control) {
        ...
        if (type == BackgroundAndFill.FILL_SHADE_LINEAR
            ...
            Color fillColor =
                    ShapeKit.getForegroundColor(escherContainer, workbook, KeyKt.APPLICATION_TYPE_SS);
            Color fillbackColor =
                    ShapeKit.getFillbackColor(escherContainer, workbook, KeyKt.APPLICATION_TYPE_SS);
