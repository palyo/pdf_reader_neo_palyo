...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.exceptions.CorruptPowerPointFileException;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.model.HeadersFooters;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.model.Hyperlink;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.model.MovieShape;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExAviMovie;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExControl;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExHyperlink;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExHyperlinkAtom;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExMCIMovie;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExObjList;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExObjListAtom;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExOleObjAtom;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExVideoContainer;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExtendedParagraphHeaderAtom;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExtendedPresRuleContainer;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExtendedPresRuleContainer.ExtendedParaAtomsSet;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.FontCollection;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.HeadersFootersContainer;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.PersistPtrHolder;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.PositionDependentRecord;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.SlideListWithText;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.SlideListWithText.SlideAtomsSet;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.SlidePersistAtom;
...
public final class SlideShow {
    ...
    private void buildSlidesAndNotes() {
        ...
        if (masterSLWT != null) {
            ...
            for (int i = 0; i < masterSets.length; i++) {
                ...
                if (r instanceof com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide) {
                    TitleMaster master = new TitleMaster((com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide) r, sheetNo);
                    master.setSlideShow(this);
                    tmr.add(master);
                } else if (r instanceof com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.MainMaster) {
                    SlideMaster master = new SlideMaster((com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.MainMaster) r, sheetNo);
                    master.setSlideShow(this);
                    mmr.add(master);
                }
            }
        ...
        com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Notes[] notesRecords;
        SlideAtomsSet[] notesSets = new SlideAtomsSet[0];
        Hashtable<Integer, Integer> slideIdToNotes = new Hashtable<Integer, Integer>();
        if (notesSLWT == null) {

            notesRecords = new com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Notes[0];
        } else {

            notesSets = notesSLWT.getSlideAtomsSets();
            ArrayList<com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Notes> notesRecordsL = new ArrayList<com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Notes>();
            for (int i = 0; i < notesSets.length; i++) {

                Record r = getCoreRecordForSAS(notesSets[i]);

                if (r instanceof com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Notes) {
                    com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Notes notesRecord = (com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Notes) r;
            ...
            notesRecords = new com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Notes[notesRecordsL.size()];
            notesRecords = notesRecordsL.toArray(notesRecords);
        }

        com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide[] slidesRecords;
        SlideAtomsSet[] slidesSets = new SlideAtomsSet[0];
        if (slidesSLWT == null) {

            slidesRecords = new com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide[0];
        } else {

            slidesSets = slidesSLWT.getSlideAtomsSets();
            slidesRecords = new com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide[slidesSets.length];
            for (int i = 0; i < slidesSets.length; i++) {

                Record r = getCoreRecordForSAS(slidesSets[i]);

                if (r instanceof com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide) {
                    slidesRecords[i] = (com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide) r;
                }
        ...
        for (int i = 0; i < _slides.length; i++) {
            ...
            if (noteId != 0) {
                Integer notesPos = slideIdToNotes.get(Integer.valueOf(noteId));
    ...
    public Dimension getPageSize() {
        ...
        int pgx = (int) (docatom.getSlideSizeX() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI);
        int pgy = (int) (docatom.getSlideSizeY() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI);
        return new Dimension(pgx, pgy);
    }

    public void setPageSize(Dimension pgsize) {
        DocumentAtom docatom = _documentRecord.getDocumentAtom();
        docatom.setSlideSizeX((long) ((long) pgsize.width * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
        docatom.setSlideSizeY((long) ((long) pgsize.height * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
    }
    ...
    public Slide removeSlide(int index) {
        ...
        Collections.addAll(nt, getNotes());
