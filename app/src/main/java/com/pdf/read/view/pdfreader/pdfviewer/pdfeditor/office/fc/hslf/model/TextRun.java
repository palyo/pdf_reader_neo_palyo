...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.model.textproperties.TextPropCollection;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.ExtendedParagraphAtom;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.StyleTextPropAtom;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.TextBytesAtom;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.TextCharsAtom;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.TextHeaderAtom;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.TextRulerAtom;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.TextSpecInfoAtom;
...
public final class TextRun {
    ...
    private ExtendedParagraphAtom _extendedParagraphAtom;
    ...
    public void buildRichTextRuns(LinkedList pStyles, LinkedList cStyles, String runRawText) {
        ...
        if (pStyles.size() == 0 || cStyles.size() == 0) {
            ...
            while (pos <= runRawText.length() && curP < pStyles.size() && curC < cStyles.size()) {
                ...
                boolean freshSet = pLenRemain == -1 && cLenRemain == -1;
                if (pLenRemain == -1) {
                    pLenRemain = pLen;
                }
                if (cLenRemain == -1) {
    ...
    public void ensureStyleAtomPresent() {
        ...
        _rtRuns[0].supplyTextProps(_styleAtom.getParagraphStyles().get(0),
                _styleAtom.getCharacterStyles().get(0), false, false);
    }
