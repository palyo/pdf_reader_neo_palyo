...
public class NamespaceStack {
    private final ArrayList namespaceStack = new ArrayList();
    private final ArrayList namespaceCacheList = new ArrayList();
    private final Map rootNamespaceCache = new HashMap();
    ...
    public String toString() {
        return super.toString() + " Stack: " + namespaceStack;
    }
