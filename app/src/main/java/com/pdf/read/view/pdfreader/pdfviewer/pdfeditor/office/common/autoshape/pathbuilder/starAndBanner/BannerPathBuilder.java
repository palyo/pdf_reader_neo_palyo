package com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.autoshape.pathbuilder.starAndBanner;
...
public class BannerPathBuilder {
    ...
    private static final List<ExtendPath> pathExList = new ArrayList<ExtendPath>(2);
