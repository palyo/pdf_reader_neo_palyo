...
public final class CHPFormattedDiskPage extends FormattedDiskPage {
    ...
    private final ArrayList<CHPX> _chpxList = new ArrayList<CHPX>();
    ...
    @Deprecated
    @SuppressWarnings("unused")
    private byte[] toByteArray(CharIndexTranslator translator, int fcMin) {
        return toByteArray(translator);
    }

    byte[] toByteArray(CharIndexTranslator translator) {
