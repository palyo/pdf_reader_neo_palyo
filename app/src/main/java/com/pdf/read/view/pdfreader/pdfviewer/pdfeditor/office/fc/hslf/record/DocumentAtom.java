...
public final class DocumentAtom extends RecordAtom {
    ...
    private DocumentAtom(byte[] source, int start, int len) {
        ...
        slideSizeX = LittleEndian.getInt(source, start + 8);
