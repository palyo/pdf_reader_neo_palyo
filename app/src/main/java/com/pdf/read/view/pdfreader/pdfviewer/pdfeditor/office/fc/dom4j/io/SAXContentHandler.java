...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.dtd.AttributeDecl;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.dtd.ElementDecl;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.dtd.ExternalEntityDecl;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.dtd.InternalEntityDecl;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.AbstractElement;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.NamespaceStack;
...
public class SAXContentHandler extends DefaultHandler implements LexicalHandler, DeclHandler,
    ...
    private final Map availableNamespaceMap = new HashMap();
    private final List declaredNamespaceList = new ArrayList();
