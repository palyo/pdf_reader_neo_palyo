...
public class nsISO2022KRVerifier extends nsVerifier {
    ...
    public nsISO2022KRVerifier() {
        ...
        states[0] = ((((((eError) << 4) | (eError)) << 8) | ((eStart) << 4) | (eStart)) << 16) | ((((eStart) << 4) | (eError)) << 8) | ((3) << 4) | (eStart);
        states[1] = ((((((eItsMe) << 4) | (eItsMe)) << 8) | ((eItsMe) << 4) | (eItsMe)) << 16) | ((((eError) << 4) | (eError)) << 8) | ((eError) << 4) | (eError);
        states[2] = ((((((eError) << 4) | (eError)) << 8) | ((4) << 4) | (eError)) << 16) | ((((eError) << 4) | (eError)) << 8) | ((eItsMe) << 4) | (eItsMe);
        states[3] = ((((((eError) << 4) | (eError)) << 8) | ((eError) << 4) | (5)) << 16) | ((((eError) << 4) | (eError)) << 8) | ((eError) << 4) | (eError);
        states[4] = ((((((eStart) << 4) | (eStart)) << 8) | ((eStart) << 4) | (eStart)) << 16) | ((((eItsMe) << 4) | (eError)) << 8) | ((eError) << 4) | (eError);
