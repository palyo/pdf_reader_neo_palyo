...
public final class POIListData {
    private static final BitField _fSimpleList = BitFieldFactory.getInstance(0x1);
    private static final BitField _fRestartHdn = BitFieldFactory.getInstance(0x2);
    private final short[] _rgistd;
