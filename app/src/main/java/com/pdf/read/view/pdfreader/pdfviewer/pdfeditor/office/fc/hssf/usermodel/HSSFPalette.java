...
public final class HSSFPalette {
    private final PaletteRecord _palette;
    ...
    private static final class CustomColor extends HSSFColor {
        private final short _byteOffset;
        private final byte _red;
        private final byte _green;
        private final byte _blue;
        ...
        public String getHexString() {
            String sb = getGnumericPart(_red) +
                    ':' +
                    getGnumericPart(_green) +
                    ':' +
                    getGnumericPart(_blue);
            return sb;
        }
