...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.AbstractDocument;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.DefaultAttribute;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.DefaultCDATA;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.DefaultComment;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.DefaultDocument;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.DefaultDocumentType;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.DefaultElement;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.DefaultText;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.tree.QNameCache;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.util.SimpleSingleton;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.util.SingletonStrategy;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.xpath.DefaultXPath;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.xpath.XPathPattern;
...
public class DocumentFactory implements Serializable {
    ...
    private static SingletonStrategy createSingleton() {
        ...
        try {
            documentFactoryClassName = System.getProperty("com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.factory",
                    "com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.DocumentFactory");
        } catch (Exception e) {
            documentFactoryClassName = "com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.DocumentFactory";
        }

        try {
            String singletonClass = System.getProperty(
                    "com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.DocumentFactory.singleton.strategy", "com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.dom4j.util.SimpleSingleton");
