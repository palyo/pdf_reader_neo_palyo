...
public final class AutoShapes {
    private static final ShapeOutline[] shapes;

    static {
        shapes = new ShapeOutline[255];

        shapes[ShapeTypes.Rectangle] = new ShapeOutline() {
            public com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.Shape getOutline(Shape shape) {
        ...
        shapes[ShapeTypes.LeftBrace] = new ShapeOutline() {
            public com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.Shape getOutline(Shape shape) {
                ...
                int adjval2 = ShapeKit.getEscherProperty(shape.getSpContainer(), EscherProperties.GEOMETRY__ADJUST2VALUE, 10800);
                GeneralPath path = new GeneralPath();
                path.moveTo(21600, 0);
    ...
    public static com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.Shape transform(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.Shape outline, Rectangle2D anchor) {
