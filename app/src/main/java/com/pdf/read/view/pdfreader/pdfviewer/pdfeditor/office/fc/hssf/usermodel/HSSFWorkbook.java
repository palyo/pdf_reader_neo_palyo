...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.POIDocument;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.codec.DigestUtils;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.OldExcelFormatException;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.formula.FormulaShifter;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.formula.SheetNameFormatter;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.formula.udf.AggregatingUDFFinder;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.formula.udf.UDFFinder;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.model.DrawingManager2;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.AbstractEscherHolderRecord;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.CellReference;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.IRow.MissingCellPolicy;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.util.WorkbookUtil;

public final class HSSFWorkbook extends POIDocument implements com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.Workbook {
    ...
    private final UDFFinder _udfFinder = UDFFinder.DEFAULT;
    private final List<HSSFSheet> _sheets;
    ...
    public int getSheetIndex(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.Sheet sheet) {
