...
public class ExcelStyleDateFormatter extends SimpleDateFormat {
    ...
    private final DecimalFormat format1digit = new DecimalFormat("0");
    private final DecimalFormat format2digits = new DecimalFormat("00");

    private final DecimalFormat format3digit = new DecimalFormat("0");
    private final DecimalFormat format4digits = new DecimalFormat("00");
