...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.xls.SSReader;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.system.ReaderHandler;

public class AWorkbook extends Workbook implements com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.Workbook {
        ...
        class WorkbookReaderHandler extends ReaderHandler {
            ...
            public void handleMessage(Message msg) {
                switch (msg.what) {
                    ...
                    case KeyKt.HANDLER_MESSAGE_DISPOSE:
                        book = null;
                        break;
                }
            }
