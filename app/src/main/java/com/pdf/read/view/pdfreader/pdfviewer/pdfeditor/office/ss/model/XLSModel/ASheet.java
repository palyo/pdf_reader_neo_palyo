...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFAutoShape;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFChart;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFChildAnchor;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFClientAnchor;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFFreeform;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFLine;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFPatriarch;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFPicture;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFPictureData;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.usermodel.HSSFShapeGroup;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.xls.ChartConverter;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.sheetProperty.PaneInformation;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.util.ModelUtil;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.util.SectionElementFactory;
...
public class ASheet extends Sheet implements com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.Sheet {
    ...
    protected ASheet(AWorkbook workbook, InternalSheet sheet) {
        ...
        List<com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.ColumnInfo> hssfColumnInfoList = sheet.getColumnInfo();
        if (hssfColumnInfoList != null) {
            Iterator<com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.ColumnInfo> iter = hssfColumnInfoList.iterator();
            while (iter.hasNext()) {
                com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.ColumnInfo hssfColumnInfo = iter.next();
                com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.sheetProperty.ColumnInfo columnInfo = new com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.sheetProperty.ColumnInfo(
                        hssfColumnInfo.getFirstCol(),
                        hssfColumnInfo.getLastCol(),
                        (int) (hssfColumnInfo.getColWidth() / 256.0 * SSConstant.COLUMN_CHAR_WIDTH * KeyKt.POINT_TO_PIXEL),
    ...
    private boolean isValidateRow(RowRecord row) {
        if (row.getFirstCol() != row.getLastCol() || row.getHeight() != DefaultRowHeightRecord.DEFAULT_ROW_HEIGHT) {
            ...
            return Workbook.isValidateStyle(book.getCellStyle(styleIndex));
        }
    }
    ...
    public Iterator<Row> rowIterator() {
        ...
        Iterator<Row> result = rows.values().iterator();
        return result;
    }
