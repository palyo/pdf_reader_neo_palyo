...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.AutoFilterInfoRecord;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.FormulaRecordAggregate;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.Region;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.DataValidation;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.DataValidationHelper;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.ICell;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.ICellStyle;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.util.SSCellRange;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.util.SheetUtil;
...
public final class HSSFSheet implements com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.Sheet {

    public final static int INITIAL_CAPACITY = 20;
    private static final POILogger log = POILogFactory.getLogger(HSSFSheet.class);
    private static final int DEBUG = POILogger.DEBUG;
    private final InternalWorkbook _book;
    ...
    public int addMergedRegion(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.util.Region region) {
    ...
    private void shiftMerged(int startRow, int endRow, int n, boolean isRow) {
    ...
    void insertChartRecords(List<Record> records) {
