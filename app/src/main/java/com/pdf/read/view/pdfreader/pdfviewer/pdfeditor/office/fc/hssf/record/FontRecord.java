...
public final class FontRecord extends StandardRecord {
    ...
    public String toString() {
        ...
        String sb = "[FONT]\n" +
                "    .fontheight    = " + String.valueOf(HexDump.shortToHex(getFontHeight())) + "\n" +
                "    .attributes    = " + String.valueOf(HexDump.shortToHex(getAttributes())) + "\n" +
                "       .italic     = " + isItalic() + "\n" +
                "       .strikout   = " + isStruckout() + "\n" +
                "       .macoutlined= " + isMacoutlined() + "\n" +
                "       .macshadowed= " + isMacshadowed() + "\n" +
                "    .colorpalette  = " + String.valueOf(HexDump.shortToHex(getColorPaletteIndex())) + "\n" +
                "    .boldweight    = " + String.valueOf(HexDump.shortToHex(getBoldWeight())) + "\n" +
                "    .supersubscript= " + String.valueOf(HexDump.shortToHex(getSuperSubScript())) + "\n" +
                "    .underline     = " + String.valueOf(HexDump.byteToHex(getUnderline())) + "\n" +
                "    .family        = " + String.valueOf(HexDump.byteToHex(getFamily())) + "\n" +
                "    .charset       = " + String.valueOf(HexDump.byteToHex(getCharset())) + "\n" +
