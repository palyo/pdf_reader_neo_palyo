package com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.autoshape.pathbuilder.baseshape;
...
public class BaseShapePathBuilder {
    ...
    private static final List<ExtendPath> paths = new ArrayList<ExtendPath>();
    ...
    private static List<ExtendPath> getCubePath(AutoShape shape, Rect rect) {
        ...
        ExtendPath extendPath = new ExtendPath();
        Path path = new Path();
        path.addRect(rect.left, rect.top + x, rect.right - x, rect.bottom, Direction.CW);
        extendPath.setBackgroundAndFill(fill);
        extendPath.setPath(path);
        extendPath.setLine(shape.getLine());
        paths.add(extendPath);
    ...
    private static List<ExtendPath> getBevelPath(AutoShape shape, Rect rect) {
        ...
        extendPath = new ExtendPath();
        path = new Path();
        path.addRect(rect.left + x, rect.top + x, rect.right - x, rect.bottom - x, Direction.CW);
