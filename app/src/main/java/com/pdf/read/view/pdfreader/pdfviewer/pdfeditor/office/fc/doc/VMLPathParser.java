...
public class VMLPathParser {
    ...
    private static final VMLPathParser instance = new VMLPathParser();

    private static final byte NodeType_Invalidate = -1;
    private static final byte NodeType_Start = 0;
    private static final byte NodeType_Middle = 1;
    private static final byte NodeType_End = 2;
    private final PointF preNode = new PointF();
    private final PointF ctrNode1 = new PointF();
    private final PointF ctrNode2 = new PointF();
    private final PointF nextNode = new PointF();
    private final StringBuilder builder = new StringBuilder();
    private final List<Integer> paraList = new ArrayList<Integer>();
