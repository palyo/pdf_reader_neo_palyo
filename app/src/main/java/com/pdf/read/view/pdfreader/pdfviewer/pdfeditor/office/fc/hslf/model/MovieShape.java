...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.AnimationInfo;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.AnimationInfoAtom;
...
public final class MovieShape extends Picture {
    ...
    private MovieShape(EscherContainerRecord escherRecord, Shape parent) {
