...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.ss.model.interfacePart.IClientAnchor;
...
public final class ClientAnchor extends Anchor implements IClientAnchor {
    ...
    private float getRowHeightInPoints(Sheet sheet, int rowNum) {
        ...
        if (row == null) {
            return 18 * KeyKt.PIXEL_TO_POINT;
        }
        return row.getRowPixelHeight() * KeyKt.PIXEL_TO_POINT;
    }
