...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.fs.storage.RawDataBlock;
...
public class Property {
    ...
    private static final int _big_block_minimum_bytes = CFBConstants.BIG_BLOCK_MINIMUM_DOCUMENT_SIZE;
    private final short _name_size;
    private final byte _property_type;
    private final int _start_block;
    private final int _size;
    private final int _chlid_property;
    private final int _next_property;
    private final int _previous_property;
    ...
    public long getPropertyRawDataSize() {
        if (blocks != null) {
            return (long) blocks[0].getData().length * blocks.length;
        }
