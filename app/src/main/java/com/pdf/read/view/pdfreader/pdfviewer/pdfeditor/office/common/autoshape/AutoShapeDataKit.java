...
public class AutoShapeDataKit {
    public static int getColor(Map<String, Integer> schemeColor, Element solidFillElement) {
        ...
        if (solidFillElement.element("srgbClr") != null) {
        ...
        } else if (solidFillElement.element("schemeClr") != null || solidFillElement.element("prstClr") != null) {
            if (schemeColor != null && schemeColor.size() > 0) {
                ...
                if (clr.element("tint") != null) {
                    color = ColorUtil.instance().getColorWithTint(color, Integer.parseInt(clr.element("tint").attributeValue("val")) / 100000.0);
                } else if (clr.element("lumOff") != null) {
                    color = ColorUtil.instance().getColorWithTint(color, Integer.parseInt(clr.element("lumOff").attributeValue("val")) / 100000.0);
                } else if (clr.element("lumMod") != null) {
                    color = ColorUtil.instance().getColorWithTint(color, Integer.parseInt(clr.element("lumMod").attributeValue("val")) / 100000.0 - 1);
                } else if (clr.element("shade") != null) {
                    color = ColorUtil.instance().getColorWithTint(color, -Integer.parseInt(clr.element("shade").attributeValue("val")) / 200000.0);
                }
    ...
    public static AbstractShape getAutoShape(IControl control, ZipPackage zipPackage, PackagePart drawingPart, Element sp, Rectangle rect, Map<String, Integer> schemeColor, int type, boolean hasTextbox) throws Exception {
        ...
        if (spPr != null) {
            ...
            if (shapeType == ShapeTypes.Line || shapeType == ShapeTypes.StraightConnector1 || shapeType == ShapeTypes.BentConnector3 || shapeType == ShapeTypes.CurvedConnector3) {
                ...
                if (type == KeyKt.APPLICATION_TYPE_WP) {
