...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.CalcCountRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.CalcModeRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.CellValueRecordInterface;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.ColumnInfoRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.ContinueRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.DVALRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.DefaultColWidthRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.DefaultRowHeightRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.DeltaRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.DimensionsRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.DrawingRecord;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.FeatHdrRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.FeatRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.GridsetRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.GutsRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.IndexRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.IterationRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.MergeCellsRecord;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.PaneRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.PrintGridlinesRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.PrintHeadersRecord;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.RefModeRecord;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.SaveRecalcRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.SelectionRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.TextObjectRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.UncalcedRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.WSBoolRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.WindowTwoRecord;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.ChartSubstreamRecordAggregate;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.ColumnInfoRecordsAggregate;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.ConditionalFormattingTable;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.CustomViewSettingsRecordAggregate;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.DataValidityTable;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.MergedCellsTable;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.PageSettingsBlock;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.RecordAggregate;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.RecordAggregate.PositionTrackingVisitor;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.RecordAggregate.RecordVisitor;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.RowRecordsAggregate;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.aggregates.WorksheetProtectionBlock;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.ColumnInfo;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.HSSFPaneInformation;
...
public final class InternalSheet {
    ...
    private final RowRecordsAggregate _rowsAggregate;
    ...
    private PrintGridlinesRecord printGridlines = null;
    private GridsetRecord gridset = null;
    private DefaultColWidthRecord defaultcolwidth = new DefaultColWidthRecord();
    private DefaultRowHeightRecord defaultrowheight = new DefaultRowHeightRecord();
    private WindowTwoRecord windowTwo = null;
    private SelectionRecord _selection = null;
    private boolean _isUncalced = false;
