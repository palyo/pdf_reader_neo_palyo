package com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss;
...
public enum SpreadsheetVersion {
    ...
    SpreadsheetVersion(int maxRows, int maxColumns, int maxFunctionArgs, int maxCondFormats, int maxText) {
        _maxRows = maxRows;
