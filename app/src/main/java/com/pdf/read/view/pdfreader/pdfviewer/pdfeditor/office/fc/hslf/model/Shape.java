...
public abstract class Shape {
    ...
    public Rectangle2D getAnchor2D() {
        ...
        if ((flags & EscherSpRecord.FLAG_CHILD) != 0) {
            ...
            if (rec == null) {
                ...
                anchor = new Rectangle2D.Float((float) clrec.getCol1() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI,
                        (float) clrec.getFlag() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI,
                        (float) (clrec.getDx1() - clrec.getCol1()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI,
                        (float) (clrec.getRow1() - clrec.getFlag()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI);
            } else {
                anchor = new Rectangle2D.Float((float) rec.getDx1() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI,
                        (float) rec.getDy1() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI,
                        (float) (rec.getDx2() - rec.getDx1()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI,
                        (float) (rec.getDy2() - rec.getDy1()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI);
            }
        } else {
            EscherClientAnchorRecord rec = (EscherClientAnchorRecord) ShapeKit.getEscherChild(
                    _escherContainer, EscherClientAnchorRecord.RECORD_ID);
            anchor = new Rectangle2D.Float((float) rec.getCol1() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI,
                    (float) rec.getFlag() * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI,
                    (float) (rec.getDx1() - rec.getCol1()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI,
                    (float) (rec.getRow1() - rec.getFlag()) * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI);
        }
        return anchor;
    }
    ...
    public void setAnchor(Rectangle2D anchor) {
        ...
        if ((flags & EscherSpRecord.FLAG_CHILD) != 0) {
            EscherChildAnchorRecord rec = (EscherChildAnchorRecord) ShapeKit.getEscherChild(_escherContainer,
                    EscherChildAnchorRecord.RECORD_ID);
            rec.setDx1((int) (anchor.getX() * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
            rec.setDy1((int) (anchor.getY() * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
            rec.setDx2((int) ((anchor.getWidth() + anchor.getX()) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
            rec.setDy2((int) ((anchor.getHeight() + anchor.getY()) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
        } else {
            EscherClientAnchorRecord rec = (EscherClientAnchorRecord) ShapeKit.getEscherChild(
                    _escherContainer, EscherClientAnchorRecord.RECORD_ID);
            rec.setFlag((short) (anchor.getY() * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
            rec.setCol1((short) (anchor.getX() * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
            rec.setDx1((short) (((anchor.getWidth() + anchor.getX()) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI)));
            rec.setRow1((short) (((anchor.getHeight() + anchor.getY()) * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI)));
        }
    ...
    public Color getLineColor() {
        return ShapeKit.getLineColor(getSpContainer(), getSheet(), KeyKt.APPLICATION_TYPE_PPT);
    }
