    ...
    public int getAutoShapeType(String name) {
        if (name != null) {
            ...
            if (name.equals("line")) {
                ...
                return ShapeTypes.UpDownArrow;
            } else if (name.equals("quadArrow")) {
                return ShapeTypes.QuadArrow;
            } else if (name.equals("leftRightUpArrow")) {
                return ShapeTypes.LeftRightUpArrow;
            } else if (name.equals("bentArrow")) {
                return ShapeTypes.BentArrow;
            } else if (name.equals("uturnArrow")) {
                return ShapeTypes.UturnArrow;
            } else if (name.equals("leftUpArrow")) {
                return ShapeTypes.LeftUpArrow;
            } else if (name.equals("bentUpArrow")) {
                return ShapeTypes.BentUpArrow;
            } else if (name.equals("curvedRightArrow")) {
                return ShapeTypes.CurvedRightArrow;
            } else if (name.equals("curvedLeftArrow")) {
                return ShapeTypes.CurvedLeftArrow;
            } else if (name.equals("curvedUpArrow")) {
                return ShapeTypes.CurvedUpArrow;
            } else if (name.equals("curvedDownArrow")) {
                return ShapeTypes.CurvedDownArrow;
            } else if (name.equals("stripedRightArrow")) {
                return ShapeTypes.StripedRightArrow;
            } else if (name.equals("notchedRightArrow")) {
                return ShapeTypes.NotchedRightArrow;
            } else if (name.equals("homePlate")) {
                return ShapeTypes.HomePlate;
            } else if (name.equals("chevron")) {
                return ShapeTypes.Chevron;
            } else if (name.equals("rightArrowCallout")) {
            ...
            } else if (name.equals("leftRightArrowCallout")) {
                return ShapeTypes.LeftRightArrowCallout;
            } else if (name.equals("quadArrowCallout")) {
                return ShapeTypes.QuadArrowCallout;
            } else if (name.equals("circularArrow")) {
            ...
            } else if (name.equals("actionButtonBackPrevious")) {
            ...
            } else if (name.equals("irregularSeal1")) {
