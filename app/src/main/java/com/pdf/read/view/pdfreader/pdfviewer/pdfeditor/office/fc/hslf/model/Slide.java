...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Comment2000;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.TextHeaderAtom;
...
public final class Slide extends Sheet {
    ...
    public Slide(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide slide, Notes notes, SlideAtomsSet atomSet,
    ...
    public Slide(int sheetNumber, int sheetRefId, int slideNumber) {
        super(new com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide(), sheetNumber);
        _slideNo = slideNumber;
    ...
    public com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide getSlideRecord() {
        return (com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide) getSheetContainer();
    }
    ...
    private SlideAtomsSet getSlideAtomsSet() {
        return _atomSet;
    }
