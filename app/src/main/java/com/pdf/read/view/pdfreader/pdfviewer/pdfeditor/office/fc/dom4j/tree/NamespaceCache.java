...
public class NamespaceCache {
    ...
    static {
        ...
        try {
            ...
            Constructor construct = clazz.getConstructor(Integer.TYPE, Float.TYPE,
                    Integer.TYPE);
            cache = (Map) construct.newInstance(new Object[]{Integer.valueOf(11), new Float(0.75f),
                    Integer.valueOf(1)});
            noPrefixCache = (Map) construct.newInstance(new Object[]{Integer.valueOf(11),
                    new Float(0.75f), Integer.valueOf(1)});
        } catch (Throwable t1) {
