...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.shape.WPChartShape;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.common.shape.WatermarkShape;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ppt.reader.ThemeReader;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.simpletext.model.Style;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.simpletext.model.StyleManage;
...
public class DOCXReader extends AbstractReader {
    private final Map<String, Integer> tableStyle = new HashMap<String, Integer>();
        ...
        if (br != null) {
            ...
            if (br.element("background") != null) {
                ...
                if (value != null) {
                    ...
                    fill.setForegroundColor(Color.parseColor("#" + value));
                }
            }
    ...
    private void processBorder(Element borElem, Border border) {
        ...
        if (value == null) {
            ...
            border.setSpace((short) (Integer.parseInt(value) * KeyKt.POINT_TO_PIXEL));
        }
    }
    ...
    private void processParaAttribute(Element pPr, IAttributeSet attr, int level) {
        ...
        if (temp != null) {
            ...
            if (val != null && val.length() > 0 && !val.equals("0")) {
                ...
                AttrManage.instance().setParaIndentLeft(attr, Math.round(fontSize * leftChars * KeyKt.POINT_TO_TWIPS));
            ...
            if (val != null && val.length() > 0 && !val.equals("0")) {
                ...
                AttrManage.instance().setParaIndentRight(attr, Math.round(fontSize * rightChars * KeyKt.POINT_TO_TWIPS));
            ...
            if (val != null && val.length() > 0 && !val.equals("0")) {
                ...
                AttrManage.instance().setParaSpecialIndent(attr, Math.round(fontSize * firstLineChars * KeyKt.POINT_TO_TWIPS));
            ...
            if (val != null && val.length() > 0 && !val.equals("0")) {
                ...
                int hanging = -Math.round(fontSize * hangingChars * KeyKt.POINT_TO_TWIPS);
        ...
        if (positionHElement != null) {
            ...
            if (positionHElement.element("align") != null) {
                ...
                rect.translate(Math.round(Integer.parseInt(positionHElement.element("posOffset").getText())
                        * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH), 0);
                    ...
                    if (pic != null) {
                        ...
                        if (chartEle != null && chartEle.attribute("id") != null) {
                            ...
                            if (ship != null) {
                                ...
                                try {
                                    AbstractChart abstrChart = ChartReader.instance().read(control, zipPackage, chartPart, themeColor, KeyKt.APPLICATION_TYPE_WP);
                                    if (abstrChart != null) {
                                        ...
                                        if (simplePos != null) {
                                            ...
                                            if (x != null) {
                                                bounds.x = (int) (Integer.parseInt(x) * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                                            }

                                            String y = simplePos.attributeValue("y");
                                            if (y != null) {
                                                bounds.y = (int) (Integer.parseInt(y) * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                                            }
                                        }
                                        ...
                                        if (extent != null) {
                                            ...
                                            if (cx != null) {
                                                bounds.width = (int) (Integer.parseInt(cx) * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                                            }

                                            String cy = extent.attributeValue("cy");
                                            if (cy != null) {
                                                bounds.height = (int) (Integer.parseInt(cy) * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                                            }
                                        }
                                    ...
                                    if (diagramRel != null) {
                                        ...
                                        if (extent != null) {
                                            if (extent.attribute("cx") != null) {
                                                ...
                                                if (val != null && val.length() > 0) {
                                                    rect.width = (int) (Integer.parseInt(val) * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                                                }
                                            }
                                            if (extent.attribute("cy") != null) {
                                                val = extent.attributeValue("cy");
                                                if (val != null && val.length() > 0) {
                                                    rect.height = (int) (Integer.parseInt(val) * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                                                }
                                            }
                                        }
    ...
    private void processAutoShapeForPict(Element sp, ParagraphElement paraElem, WPGroupShape parent, float zoomX, float zoomY) {
        ...
        if ("group".equalsIgnoreCase(name)) {
            ...
            if (rect != null) {
                ...
                childRect.x = (int) (x * zoom[0] * zoomX * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                childRect.y = (int) (y * zoom[1] * zoomY * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                childRect.width = (int) (w * zoom[0] * zoomX * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                childRect.height = (int) (h * zoom[1] * zoomY * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH);
                if (parent == null) {
                    childRect.x += rect.x;
                    childRect.y += rect.y;
                }
        ...
        if (shape != null && autoShape != null && shape.attribute("style") != null) {
            ...
            if (shape.attribute("style") != null) {
                ...
                if (styleStr != null) {
                        ...
                        if (temps != null && temps[0] != null && temps[1] != null) {
                            if ("left".equalsIgnoreCase(temps[0])) {
                                ...
                                if (index > 0) {
                                    ...
                                    if (index > 0) {
                                        x += Float.parseFloat(temps[1].substring(0, index)) * KeyKt.POINT_DPI;
                                    } else {
                                        x += Float.parseFloat(temps[1]) * zoomX * KeyKt.POINT_DPI / KeyKt.EMU_PER_INCH;
                                    }
                                }
                                ...
                                if (index > 0) {
                                    ...
                                    index = temps[1].indexOf("in");
                                    if (index > 0) {
                                        y += Float.parseFloat(temps[1].substring(0, index)) * KeyKt.POINT_DPI;
                                    } else {
                                        y += Float.parseFloat(temps[1]) * zoomY * KeyKt.POINT_DPI / KeyKt.EMU_PER_INCH;
                                    }
                                }
                                ...
                                if (index > 0) {
                                    ...
                                    if (index > 0) {
                                        ...
                                        x += Float.parseFloat(temps[1]) * KeyKt.POINT_DPI / KeyKt.EMU_PER_INCH;
                                    }
                                }
                                ...
                                if (index > 0) {
                                    ...
                                    if (index > 0) {
                                        ...
                                        y += Float.parseFloat(temps[1]) * KeyKt.POINT_DPI / KeyKt.EMU_PER_INCH;
                                    }
                                }
                                ...
                                if (index > 0) {
                                    ...
                                    index = temps[1].indexOf("in");
                                    if (index > 0) {
                                        w = Float.parseFloat(temps[1].substring(0, index)) * KeyKt.POINT_DPI;
                                    } else {
                                        w = Float.parseFloat(temps[1]) * zoomX * KeyKt.POINT_DPI / KeyKt.EMU_PER_INCH;
                                    }
                                }
                                ...
                                if (index > 0) {
                                    ...
                                    index = temps[1].indexOf("in");
                                    if (index > 0) {
                                        h = Float.parseFloat(temps[1].substring(0, index)) * KeyKt.POINT_DPI;
                                    } else {
                                        h = Float.parseFloat(temps[1]) * zoomY * KeyKt.POINT_DPI / KeyKt.EMU_PER_INCH;
                                    }
                                }
                            }
                        }
                    ...
                    rect = new Rectangle();
                    rect.x = (int) (x * KeyKt.POINT_TO_PIXEL);
                    rect.y = (int) (y * KeyKt.POINT_TO_PIXEL);
                    rect.width = (int) (w * KeyKt.POINT_TO_PIXEL);
                    rect.height = (int) (h * KeyKt.POINT_TO_PIXEL);
    ...
    private float getValueInPt(String value, float zoom) {
        ...
        if (value.contains("pt")) {
            ...
            return Float.parseFloat(value.substring(0, index)) * KeyKt.POINT_DPI;
        } else if (value.contains("mm")) {
            index = value.indexOf("mm");
            return Float.parseFloat(value.substring(0, index)) * KeyKt.MM_TO_POINT;
        } else {
            return Float.parseFloat(value) * zoom * KeyKt.POINT_DPI / KeyKt.EMU_PER_INCH;
        }
    }
    ...
    private float getValue(String value) {
        ...
        if (index > 0) {
            ...
            index = value.indexOf("in");
            if (index > 0) {
                w = Float.parseFloat(value.substring(0, index)) * KeyKt.POINT_DPI;
            } else {
                w = Float.parseFloat(value) * KeyKt.POINT_DPI / KeyKt.EMU_PER_INCH;
            }
        }

        return w * KeyKt.POINT_TO_PIXEL;
    }
    ...
    private Line processLine(Element shape) {
        ...
        if (shape.attributeValue("strokeweight") != null) {
            ...
            lineWidth = Math.round(Float.parseFloat(val) * KeyKt.POINT_TO_PIXEL);
        }
    ...
    private Gradient readGradient(Element shape, Element fillElem, byte type) {
        ...
        if (intermediateColors != null) {
            ...
            for (int i = 0; i < length; i++) {
                ...
                colors[i] = getColor(positionColor[i].substring(index + 1), true);
            }
        } else {
                    ...
                    try {
                        if (isProcessHF && hfPart != null) {
                            shape = AutoShapeDataKit.getAutoShape(control, zipPackage, hfPart, sp,
                                    rect, themeColor, KeyKt.APPLICATION_TYPE_WP, hasTextbox2010(sp));
                            if (shape != null) {
    ...
    private int processValue(String val, boolean isLeftRight) {
        ...
        if (val != null) {
            ...
            if (ReaderKit.instance().isDecimal(val)) {
                a = (int) (Integer.parseInt(val) * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH * KeyKt.PIXEL_TO_TWIPS);
            } else {
                a = (int) (Integer.parseInt(val, 16) * KeyKt.PIXEL_DPI / KeyKt.EMU_PER_INCH * KeyKt.PIXEL_TO_TWIPS);
            }
        }
        return a;
    }
    ...
    private boolean processTextbox2007(PackagePart packagePart, WPAutoShape wpShape, Element sp) {
        ...
        if (txbx != null) {
            ...
            if (txbxContent != null) {
                ...
                AttrManage.instance().setPageWidth(attr, (int) (wpShape.getBounds().width * KeyKt.PIXEL_TO_TWIPS));

                AttrManage.instance().setPageHeight(attr, (int) (wpShape.getBounds().height * KeyKt.PIXEL_TO_TWIPS));
                ...
                if (inset != null) {
                    ...
                    if (insets.length > 0 && insets[0].length() > 0) {
                        ...
                        leftMargin = Math.round(getValueInPt(insets[0], 1.0f) * KeyKt.POINT_TO_TWIPS);
                    }

                    if (insets.length > 1 && insets[1].length() > 0) {

                        topMargin = Math.round(getValueInPt(insets[1], 1.0f) * KeyKt.POINT_TO_TWIPS);
                    }

                    if (insets.length > 2 && insets[2].length() > 0) {

                        rightMargin = Math.round(getValueInPt(insets[2], 1.0f) * KeyKt.POINT_TO_TWIPS);
                    }

                    if (insets.length > 3 && insets[3].length() > 0) {

                        bottomMargin = Math.round(getValueInPt(insets[3], 1.0f) * KeyKt.POINT_TO_TWIPS);
                    }
                }
            ...
            if (len > 0) {
                ...
                float width = (float) wpShape.getBounds().getWidth() - ShapeKit.DefaultMargin_Twip * 4 * KeyKt.TWIPS_TO_PIXEL;
                float height = (float) wpShape.getBounds().getHeight() - ShapeKit.DefaultMargin_Twip * 2 * KeyKt.TWIPS_TO_PIXEL;
    ...
    private void processRelativeShapeSize() {
        ...
        while (iter.hasNext()) {
            ...
            if (val[0] > 0) {
                r.width = (int) (w * KeyKt.TWIPS_TO_PIXEL * val[0] / 1000f);
            }

            if (val[2] > 0) {
                r.height = (int) (h * KeyKt.TWIPS_TO_PIXEL * val[2] / 1000f);
            }
        }
    }
