...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.sprm.CharacterSprmUncompressor;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.sprm.ParagraphSprmUncompressor;
...
public final class StyleSheet implements HDFType {
    ...
    private final int _cbSTDBaseInFile;

    private final int _flags;

    private final int _stiMaxWhenSaved;

    private final int _istdMaxFixedWhenSaved;

    private final int nVerBuiltInNamesWhenSaved;

    private final int[] _rgftcStandardChpStsh;
