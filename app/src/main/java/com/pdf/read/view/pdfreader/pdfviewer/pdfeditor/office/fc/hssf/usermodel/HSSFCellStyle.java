...
public final class HSSFCellStyle implements ICellStyle {
    ...
    public String getDataFormatString(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.Workbook workbook) {
    ...
    public String getDataFormatString(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.model.InternalWorkbook workbook) {
    ...
    public HSSFFont getFont(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.ss.usermodel.Workbook parentWorkbook) {
    ...
    private void checkDefaultBackgroundFills() {
        if (_format.getFillForeground() == com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.HSSFColor.AUTOMATIC.index) {
            if (_format.getFillBackground() != (com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.HSSFColor.AUTOMATIC.index + 1))
                setFillBackgroundColor((short) (com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.HSSFColor.AUTOMATIC.index + 1));
        } else if (_format.getFillBackground() == com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.HSSFColor.AUTOMATIC.index + 1)
            if (_format.getFillForeground() != com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.HSSFColor.AUTOMATIC.index)
                setFillBackgroundColor(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.util.HSSFColor.AUTOMATIC.index);
    }
