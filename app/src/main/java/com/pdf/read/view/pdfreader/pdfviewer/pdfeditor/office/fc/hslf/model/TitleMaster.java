...
public final class TitleMaster extends MasterSheet {
    ...
    public TitleMaster(com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide record, int sheetNo) {
    ...
    public MasterSheet getMasterSheet() {
        ...
        SlideAtom sa = ((com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.record.Slide) getSheetContainer()).getSlideAtom();
