...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.Shape;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.geom.Area;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.geom.GeneralPath;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.java.awt.geom.IllegalPathStateException;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.thirdpart.emf.data.BasicStroke;
...
public class EMFRenderer {
    private static final Logger logger = Logger.getLogger("com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.thirdpart.emf");

    public static double TWIP_SCALE = 1d / 1440 * 254;

    private final EMFHeader header;

    private final GDIObject[] gdiObjects = new GDIObject[256];
    private final Paint brushPaint = new Paint();
    private final Paint penPaint = new Paint();

    private final Vector tags = new Vector(0);

    private final Stack dcStack = new Stack();
    ...
    public void fillShape(Shape shape) {
        ...
        Style tmp = brushPaint.getStyle();
        brushPaint.setStyle(Style.FILL);
