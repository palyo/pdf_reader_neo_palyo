...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.fs.filesystem.BlockSize;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.fs.filesystem.CFBConstants;

public final class BlockAllocationTableReader {

    private final IntList _entries;
    private final BlockSize bigBlockSize;
        ...
        if (block_index < block_count) {
            ...
            for (int j = 0; j < xbat_count; j++) {
                ...
                for (int k = 0; k < limit; k++) {
                    blocks[block_index++] = raw_block_list.remove(LittleEndian.getInt(data, offset));
