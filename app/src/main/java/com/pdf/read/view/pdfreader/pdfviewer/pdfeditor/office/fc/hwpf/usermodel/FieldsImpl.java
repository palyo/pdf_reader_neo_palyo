...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.model.FieldDescriptor;
...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hwpf.model.PlexOfField;

public class FieldsImpl implements Fields {
    private final Map<FieldsDocumentPart, Map<Integer, FieldImpl>> _fieldsByOffset;
    private final PlexOfFieldComparator comparator = new PlexOfFieldComparator();
