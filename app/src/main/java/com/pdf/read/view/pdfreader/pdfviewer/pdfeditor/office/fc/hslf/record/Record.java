...
public abstract class Record {
    ...
    public static Record createRecordForType(long type, byte[] b, int start, int len) {
        ...
        try {
            ...
            java.lang.reflect.Constructor<? extends Record> con = c.getDeclaredConstructor(byte[].class, Integer.TYPE, Integer.TYPE);

            toReturn = con.newInstance(b, Integer.valueOf(start), Integer.valueOf(len));
