...
class FavoriteFragment : BaseFragment<FragmentFavoriteBinding>(FragmentFavoriteBinding::inflate) {
    ...
    private var dataViewModel: FavoriteViewModel? = null
    ...
    private fun FragmentFavoriteBinding.setupData() {
        activity?.apply context@{
            ...
            dataViewModel?.favorites?.observe(this@FavoriteFragment) { documents ->
    ...
    private fun FragmentFavoriteBinding.setupAdapter() {
        activity?.apply context@{
            recyclerView.apply {
    ...
    override fun FragmentFavoriteBinding.initListeners() {
        activity?.apply context@{
        }
    }
    ...
    override fun create() {
        activity?.apply {
            dataViewModel = ViewModelProvider(this, FavoriteViewModelFactory(favoriteLikeDao = favoriteLikeDao))[FavoriteViewModel::class.java]
        }
    }
