...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.model.TextRun;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.model.textproperties.BitMaskTextProp;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.model.textproperties.CharFlagsTextProp;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hslf.model.textproperties.ParagraphFlagsTextProp;
...
public final class RichTextRun {
    ...
    public int getBulletOffset() {
        return (int) (getParaTextPropVal("bullet.offset") * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI);
    }

    public void setBulletOffset(int offset) {
        setParaTextPropVal("bullet.offset", (int) (offset * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
    }

    public int getTextOffset() {
        return (int) (getParaTextPropVal("text.offset") * KeyKt.POINT_DPI / ShapeKit.MASTER_DPI);
    }

    public void setTextOffset(int offset) {
        setParaTextPropVal("text.offset", (int) (offset * ShapeKit.MASTER_DPI / KeyKt.POINT_DPI));
    }
