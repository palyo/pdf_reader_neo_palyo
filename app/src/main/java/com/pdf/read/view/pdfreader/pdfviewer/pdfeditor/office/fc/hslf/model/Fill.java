...
public final class Fill {
    ...
    public Color getForegroundColor() {
        return ShapeKit.getForegroundColor(shape.getSpContainer(), shape.getSheet(), KeyKt.APPLICATION_TYPE_PPT);
    }
    ...
    public Color getFillbackColor() {
        return ShapeKit.getFillbackColor(shape.getSpContainer(), shape.getSheet(), KeyKt.APPLICATION_TYPE_PPT);
    }
