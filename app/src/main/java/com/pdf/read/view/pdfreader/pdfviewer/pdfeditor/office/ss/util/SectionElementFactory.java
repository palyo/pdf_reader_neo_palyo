...
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.common.UnicodeString;
import com.pdf.read.view.pdfreader.pdfviewer.pdfeditor.office.fc.hssf.record.common.UnicodeString.FormatRun;
...
public class SectionElementFactory {
    ...
    public static SectionElement getSectionElement(Workbook workbook, HSSFTextbox textbox, Rectangle rect) {
        ...
        AttrManage.instance().setPageMarginLeft(attr, Math.round(textbox.getMarginLeft() * KeyKt.PIXEL_TO_TWIPS));

        AttrManage.instance().setPageMarginTop(attr, Math.round(textbox.getMarginTop() * KeyKt.PIXEL_TO_TWIPS));
        AttrManage.instance().setPageMarginRight(attr, Math.round(textbox.getMarginRight() * KeyKt.PIXEL_TO_TWIPS));
        AttrManage.instance().setPageMarginBottom(attr, Math.round(textbox.getMarginBottom() * KeyKt.PIXEL_TO_TWIPS));
